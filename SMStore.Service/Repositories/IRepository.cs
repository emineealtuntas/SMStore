...
using System.Linq.Expressions; //Expression lar veriyi sorgularken lambda Expression kullanabilmemizi sağlar. Örneğin p=>p.Id == id gibi 
using System.Text;
...
namespace SMStore.Service.Repositories
{
    ...
    {
        // Burada uygulamada kullanacağımız crud metodlarının imzalarını belirliyoruz.
