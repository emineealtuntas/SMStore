...
// .Net Core ile birlikte 3 farklý Dependency Injection yöntemi varsayýlan olarak kullanýmýmýza sunulmuþtur
// Dependency Injection Yöntemleri :
//1-AddSingleTon : Bu yöntemi kullanýrsak oluþturmak istediðimiz nesneden 1 tane oluþturulur ve her istediðimizde bu nesne bize gönderilir
...
builder.Services.AddScoped(typeof(ICategoryRepository), typeof(CategoryRepository)); // Uygulamaya ICategoryRepository i kullanmak için istek yapýlýrsa CategoryRepository nesnesinde bir örneði kullanmak üzere gönder
...
builder.Services.AddAuthentication(CookieAuthenticationDefaults.AuthenticationScheme).AddCookie(x=>
{
    ...
    x.LogoutPath = "/Admin/Logout"; // çýkýþ yapma yetkisi verir
    x.Cookie.Name = "Admin"; // Oluþacak cooki ye Admin ismini verdirdik
...
app.UseAuthorization(); // Oturum açan kullanýcýyý yetkilendirme(admin panelini kullanma yetkisi)
