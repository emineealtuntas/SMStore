...
namespace SMStore.WebUIAPIUsing.Areas.Admin.Controllers
{
    ...
    public class AppUsersController : Controller
    {
        ...
        public AppUsersController(HttpClient httpClient)
        {
            ...
            _apiAdres = "https://localhost:44340/api/AppUsers";
        }

        // GET: AppUsersController
        public async Task<IActionResult> IndexAsync()
        {
            var model = await _httpClient.GetFromJsonAsync<List<AppUser>>(_apiAdres); // _httpClient nesnesi Api ye istekler, gönderemek için kullanılır. GetFromJsonAsync metodu ise _apiAdres deki api mize yaptığı istek sonucu gelen json data yı List<AppUser> yani app user listesine dönüştürür ve view a gönderir.
            return View(model);
        }
